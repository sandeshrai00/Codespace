        ...
        {isMenuOpen && (
          <div className="md:hidden pb-4 animate-slide-down bg-white/95 backdrop-blur-md absolute right-4 top-16 w-72 shadow-xl border border-gray-100 rounded-2xl">
            ...
            <div className="px-2 py-3 space-y-1">
              <Link 
                href={`/${lang}/tours`}
                className="block px-3 py-2.5 text-gray-700 hover:text-primary-600 hover:bg-primary-50 rounded-md transition-all duration-200 font-bold border border-primary-600"
