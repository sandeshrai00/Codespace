    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Column 1: Brand */}
          <div>
            <h3 className="text-2xl font-bold mb-4 text-primary-400">GoHoliday</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/tours" className="text-gray-400 hover:text-primary-400 transition">
                  All Tours
                </Link>
              </li>
              <li>
                <Link href="/#featured" className="text-gray-400 hover:text-primary-400 transition">
                  Featured Tours
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-whatsapp hover:text-white transition group"
                >
      ...
      <div className="border-t border-gray-800">
        <div className="container mx-auto px-4 py-6">
          <p className="text-center text-gray-500 text-sm">
            © {currentYear} GoHoliday. All rights reserved. Made with ❤️ for travelers.
          </p>
        </div>
      </div>
    </footer>
