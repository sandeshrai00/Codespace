  ...
  return (
    <div className="min-h-screen">
            ...
            >
              <div className="absolute inset-0">
                <img 
                  ...
                  alt="Thailand destination with turquoise waters, golden temples, and tropical palm beaches"
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                />
              </div>
            ...
            >
              <div className="absolute inset-0">
                <img 
                  ...
                  alt="Bali destination showcasing lush rice terraces, ancient Hindu temples, and tropical island scenery"
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                />
              </div>
              <div className="absolute inset-0 bg-gradient-to-t from-primary-900/90 via-primary-900/50 to-transparent group-hover:from-primary-800/90 transition-all duration-300"></div>
            ...
            >
              <div className="absolute inset-0">
                <img 
                  ...
                  alt="European destinations featuring historic architecture, cobblestone streets, and iconic city landmarks"
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                />
              </div>
            ...
            >
              <div className="absolute inset-0">
                <img 
                  ...
                  alt="Maldives destination with overwater bungalows, crystal clear turquoise lagoons, and white sand beaches"
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                />
              </div>
      ...
      <section className="relative py-20 bg-gradient-to-br from-secondary-900 via-primary-900 to-secondary-950 text-white overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-primary-500/20 rounded-full blur-3xl animate-float-delayed"></div>
        
        <div className="container mx-auto px-4 relative z-10">
          {/* Section Header with Limited Time Badge */}
          <div className="text-center mb-12 animate-fade-in">
            <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-accent-500 to-accent-600 rounded-full mb-6 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="relative group">
              <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 border border-white/20 shadow-glass hover:shadow-glass-lg transition-all duration-300 hover:scale-105 hover:bg-white/15">
                ...
                <div className="absolute top-4 right-4 opacity-50 group-hover:opacity-100 transition-opacity">
                  <svg className="w-6 h-6 text-accent-400" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
            ...
            <div className="relative group">
              <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 border border-white/20 shadow-glass hover:shadow-glass-lg transition-all duration-300 hover:scale-105 hover:bg-white/15">
                ...
                <div className="absolute top-4 right-4 opacity-50 group-hover:opacity-100 transition-opacity">
                  <svg className="w-6 h-6 text-primary-400" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
