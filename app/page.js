...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section with Search Bar Overlay - TourRadar Style */}
      <section className="relative bg-gradient-to-br from-secondary-700 via-secondary-800 to-secondary-900 text-white py-24 md:py-32 overflow-hidden">
        {/* Background Pattern */}
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8 max-w-4xl mx-auto">
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <Link 
                  href="/tours" 
                  className="px-8 py-4 bg-primary-600 text-white rounded-xl font-bold text-lg hover:bg-primary-700 transition shadow-lg hover:shadow-xl whitespace-nowrap"
                >
                  Search Tours
                </Link>
              </div>
      ...
      {/* Popular Destinations Section - TourRadar Style */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            {[
              ...
              <Link 
                key={dest.name}
                href="/tours" 
                className="group relative h-48 rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300"
              >
      ...
      {/* Stats/Social Proof Bar - TourRadar Style */}
      <section className="py-12 bg-secondary-800 text-white">
        <div className="container mx-auto px-4">
          ...
          {featuredTours.length > 0 ? (
            <>
              ...
              <div className="text-center">
                <Link 
                  href="/tours" 
                  className="inline-flex items-center gap-2 px-8 py-4 bg-primary-600 text-white rounded-xl font-semibold text-lg hover:bg-primary-700 transition shadow-md hover:shadow-lg"
                >
                  View All Tours
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {/* Feature 1 */}
            <div className="bg-white border-2 border-gray-100 p-6 rounded-xl shadow-sm hover:shadow-lg hover:border-primary-200 transition-all">
            ...
            {/* Feature 2 */}
            <div className="bg-white border-2 border-gray-100 p-6 rounded-xl shadow-sm hover:shadow-lg hover:border-primary-200 transition-all">
              <div className="w-16 h-16 bg-secondary-100 rounded-2xl flex items-center justify-center mb-4 mx-auto">
      ...
      {/* Newsletter Section - NEW TourRadar Feature */}
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-2xl mx-auto">
              <input
                ...
                className="flex-1 px-6 py-4 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500 text-lg"
              />
              <button className="px-8 py-4 bg-primary-600 text-white rounded-xl font-bold text-lg hover:bg-primary-700 transition shadow-lg hover:shadow-xl whitespace-nowrap">
                Subscribe
              </button>
            </div>
